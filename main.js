...
function car2_up()
{
	...
	{
		car2_y=car2_y-10;
	console.log("When up arrow is pressed, x = " + car2_x+ car2_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2_y=car2_y-10;
	console.log("When right arrow is pressed, x = " + car2_x+ car2_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2_y=car2_y + 10;
	console.log("When left arrow is pressed, x = " + car2_x+ car2_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
	}
